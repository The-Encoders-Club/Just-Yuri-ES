...
screen chess(fen, player_color, movetime, depth):
    ...
    fixed xpos 20 ypos 390 spacing 30:
        vbox:
            showif chess_displayable.whose_turn == WHITE:
                text 'Turno de: Blancas' style 'game_status_text'
            else:
                text 'Turno de: Negras' style 'game_status_text'
            ...
            text 'Movimientos más recientes' style 'game_status_text' xalign 0.5
    ...
    fixed xpos 200 ypos 390:
        vbox:
            hbox spacing 5:
                ...
                textbutton '⚐':
                    action [Confirm('¿Deseas rendirte?',
                        yes=[
            ...
            hbox spacing 5:
                text 'Vista de tablero invertido' color COLOR_WHITE size 13 yalign 0.5
                textbutton '↑↓':
    ...
    showif chess_displayable.show_promotion_ui:
        text 'Elije la pieza a promocionar' xpos 20 ypos 550 color COLOR_WHITE size 18
    ...
    class ChessDisplayable(renpy.Displayable):
            ...
            if 0 < x < CHESS_BOARD_SIDE_LEN and 0 < y < CHESS_BOARD_SIDE_LEN and ev.type == pygame.MOUSEBUTTONDOWN and ev.button == 1:
                ...
                if self.src_coord is None:
                    ...
                    if self.show_promotion_ui and not move.promotion:
                        renpy.notify('Seleccione un tipo de piece para promocionar')
        ...
        def check_game_status(self):
            ...
            if self.board.is_checkmate():
                ...
                renpy.notify('¡Jaque mate! El winner es %s' % ('black' if self.whose_turn else 'white'))
        ...
        def show_claim_draw_ui(self, reason=''):
            ...
            renpy.show_screen('confirm', 
                message=reason + '¿Le gustaría solicitar un empate?', 
                yes_action=[
                    Hide('confirm'),
                    Play('sound', AUDIO_DRAW),
                    Return(DRAW)
